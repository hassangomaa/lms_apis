...
<?php endif; ?>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo e(route('posts.list')); ?>">POSTS  <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
...
<?php /**PATH /home/u406110375/domains/qudratqudratooooo.online/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>