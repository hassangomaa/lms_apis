...
use App\Models\OrgPolicyCourseList;
use App\Models\OrgAttendance;
use App\Models\OrgSubscriptionCheckout;
use App\Models\OrgSubscriptionCourseList;
use App\Models\Cart;
use Illuminate\Support\Facades\Auth;
use App\Models\OnlineQuiz;
use Illuminate\Database\Eloquent\Model;
use App\Models\Language;
use App\Models\InfixHomework;
use App\Models\QuizTest;
use App\Models\Survey;
use App\Models\ClassComplete;
use App\Models\VirtualClass;
use App\Models\SubscriptionCourseList;
...
//            $checkouts = OrgSubscriptionCheckout::where('user_id', \auth()->id())
...
//                $now = Carbon::now();
//                $expireDateTime = Carbon::parse($checkout->end_date . ' ' . $checkout->end_time);
//                if ($now->gt($expireDateTime)) {
//                    continue;
//                }
//                foreach ($checkout->plan->assign as $assign) {
