...
{{--    </div>--}}
    <!-- Spinner End -->
    @if(Settings('preloader_type')==2)
        <div class="preloader" dir="ltr" >
            <img style="width: 200px" src="{{asset(Settings('preloader_image'))}}" alt="">
        </div>
    @else
        @if(!Settings('preloader_style')||Settings('preloader_style')==0)
        ...
        @elseif(Settings('preloader_style')==1)
            <div class="preloader" dir="ltr">
                <div class="circle circle1"></div>
            </div>
        @elseif(Settings('preloader_style')==2)


            <div class="preloader" dir="ltr">
                <div class="circle circle2"></div>
            </div>
        @elseif(Settings('preloader_style')==3)
            <div class="preloader" dir="ltr">
                <div class="circle circle3 c31"></div>
                <div class="circle circle3 c32"></div>
            </div>
        @elseif(Settings('preloader_style')==4)
            <div class="preloader" dir="ltr">
        ...
        @elseif(Settings('preloader_style')==5)
            <div class="preloader" dir="ltr">
                <div class="circle circle5 c51"></div>
            </div>
        @elseif(Settings('preloader_style')==6)
            <div class="preloader" dir="ltr">
        ...
        @elseif(Settings('preloader_style')==7)
            <div class="preloader" dir="ltr">
        ...
        @elseif(Settings('preloader_style')==8)
            <div class="preloader" dir="ltr">
        ...
        @elseif(Settings('preloader_style')==9)
            <div class="preloader" dir="ltr">
        ...
        @elseif(Settings('preloader_style')==10)
            <div class="preloader" dir="ltr">
        ...
        @elseif(Settings('preloader_style')==11)
        ...
        @elseif(Settings('preloader_style')==12)
        ...
        @elseif(Settings('preloader_style')==13)

            <div class="preloader" dir="ltr">
                <div class="circle circle13 c131"></div>
            </div>
        @elseif(Settings('preloader_style')==14)

            <div class="preloader" dir="ltr">
                <div class="circle circle14 c141"></div>
            </div>
        @elseif(Settings('preloader_style')==15)

            <div class="preloader" dir="ltr">
                <div class="circle circle15 c151"></div>
            </div>
        @elseif(Settings('preloader_style')==16)
        ...
        @elseif(Settings('preloader_style')==17)
        ...
        @elseif(Settings('preloader_style')==18)

            <div class="preloader" dir="ltr">
                <div class="dot dot3"></div>
                <div class="dot dot3 dot31"></div>
            </div>
        @elseif(Settings('preloader_style')==19)

            <div class="preloader" dir="ltr">
                <div class="dot dot4"></div>
                <div class="dot dot4 dot41"></div>
            </div>
        @elseif(Settings('preloader_style')==20)
        ...
        @elseif(Settings('preloader_style')==21)
        ...
        @elseif(Settings('preloader_style')==22)
        ...
        @elseif(Settings('preloader_style')==23)
        ...
        @elseif(Settings('preloader_style')==24)
